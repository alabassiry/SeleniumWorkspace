...
public class Testcase004 {
	...
	private Object[][] dataprovider() {
		Object[][] testData = excel.getTestData("Invalid_Password");
		return testData;
	}

	@Test(dataProvider = "loginData")
	public void testingInvalidPassword(String firstname, String lastname, String password, String email, String phone)
		...
		rpf.clickSubmit();
		check = rpf.errorMessageFor("password");
