...
public class Testcase003 {
	...
	private Object[][] dataprovider() {
		Object[][] testData = excel.getTestData("Invalid_LastName");
		return testData;
	}

	@Test(dataProvider = "loginData")
	public void testingInvalidLastName(String firstname, String lastname, String password, String email, String phone)
		...
		rpf.clickSubmit();
		check = rpf.errorMessageFor("last name");
