...
public class Testcase006 {
	...
	private Object[][] dataprovider() {
		Object[][] testData = excel.getTestData("Invalid_Phone");
		return testData;
	}

	@Test(dataProvider = "loginData")
	public void testingInvalidPhoneNumber(String firstname, String lastname, String password, String email, String phone)
		...
		rpf.clickSubmit();
		check = rpf.errorMessageFor("phone");
